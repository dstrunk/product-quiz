...
namespace Silentpost\ProductQuiz\Query\Question;
...
use Silentpost\ProductQuiz\Mapper\QuestionDataMapper;
...
/**
 * Get Question list by search criteria query.
 */
class GetListQuery
{
    /**
     ...
     * @param QuestionCollectionFactory $entityCollectionFactory
     * @param QuestionDataMapper $entityDataMapper
     * @param SearchCriteriaBuilder $searchCriteriaBuilder
     * @param SearchResultsInterfaceFactory $searchResultFactory
     */
    public function __construct(
        CollectionProcessorInterface $collectionProcessor,
        QuestionCollectionFactory $entityCollectionFactory,
        QuestionDataMapper $entityDataMapper,
