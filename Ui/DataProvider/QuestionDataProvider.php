...
namespace Silentpost\ProductQuiz\Ui\DataProvider;
...
use Silentpost\ProductQuiz\Query\Question\GetListQuery;
...
class QuestionDataProvider extends DataProvider
{
    ...
    public function getData(): array
    {
        ...
        foreach ($this->loadedData['items'] as $item) {
            $itemsById[(int)$item['question_id']] = $item;
        }

        if ($id = $this->request->getParam('question_id', null)) {
