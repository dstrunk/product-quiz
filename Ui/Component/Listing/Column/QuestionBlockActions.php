 ...
 */
class QuestionBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Question';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'productquiz/question/edit';
    private const DELETE_URL_PATH = 'productquiz/question/delete';
    /** #@- */
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['question_id'])) {
                    ...
                    $urlData = ['question_id' => $item['question_id']];
