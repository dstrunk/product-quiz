 ...
 */
class AnswerBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'Answer';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'productquiz/answer/edit';
    private const DELETE_URL_PATH = 'productquiz/answer/delete';
    /** #@- */
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['answer_id'])) {
                    ...
                    $urlData = ['answer_id' => $item['answer_id']];
